...
python btcrecover.py --bip39 --bip32-path "m/49'/0'/0'/0" --addr-limit $1 --passwordlist $2 --mnemonic "$3" --dsw --skip-pre-start --no-dupchecks --no-dupchecks --no-dupchecks --no-dupchecks $4
