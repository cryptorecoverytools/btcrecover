...
if [ $# -lt 3 ]; then
    ...
    echo ""
    echo "Example: $0 10 pwd.txt \"your mnemonic phrase\""
    echo ""
...
# crunch 1 8 0123456789 -o pwd.txt

python btcrecover.py --bip39 --bip32-path "m/44'/0'/0'/0" --force-bip44 --disable-p2sh --disable-p2tr --disable-bip84 --addr-limit $1 --passwordlist $2 --mnemonic "$3" --dsw --skip-pre-start -d -d -d -d --no-eta $4 $5 $6 $7 $8
