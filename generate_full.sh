...
python btcrecover.py --bip39 --force-bip44 --force-p2sh --force-p2tr --force-bip84 --addr-limit $1 --passwordlist $2 --mnemonic "$3" --dsw --skip-pre-start --no-dupchecks --no-dupchecks --no-dupchecks --no-dupchecks --no-eta $4
