...
python btcrecover.py --bip39 --bip32-path "m/84'/0'/$2'/0" --force-bip84 --addr-limit $1 --passwordlist $3 --mnemonic "$4" --dsw --skip-pre-start --no-dupchecks --no-dupchecks --no-dupchecks --no-dupchecks --no-eta $5
